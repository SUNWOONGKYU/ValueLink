...
-- ============================================
-- PART A: 기존 테이블 트리거 (8개)
-- (updated_at 컬럼이 있는 테이블만)
-- ============================================
...
CREATE TRIGGER update_report_draft_sections_updated_at
BEFORE UPDATE ON public.report_draft_sections
FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

CREATE TRIGGER update_draft_method_status_updated_at
BEFORE UPDATE ON public.draft_method_status
FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
